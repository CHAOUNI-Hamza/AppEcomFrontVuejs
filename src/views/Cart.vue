        ...
        <div class="cart">
            <div class="row">
                            ...
                            <ul>
                                <li v-for="item in cart" :key="item.id">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="product-line-grid-body">
                                                <div class="product-line-info">
                                                    <a class="label" href="http://demo.posthemes.com/pos_nego/layout3/fr/accueil/3-13-printed-dress.html#/1-taille-s/13-couleur-orange" data-id_customization="0">{{ item.name }}</a>
                                                </div>
                                                <div class="product-line-info product-price h5">
                                                    <div class="current-price">
                                                        <span class="price">{{ (item.price * calculCurrency).toFixed(2) }} &nbsp;{{ currency }}</span>
                                                    </div>
                                                </div>
                                                <div class="product-line-info">
                                        ...
                                        <div class="col-md-3">
                                            <div class="price">
                                                {{ (item.price * calculCurrency).toFixed(2) * item.qty }} &nbsp;{{ currency }}
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="delete">
                                                <button @click="removeItemFromCart(item.id)"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div v-if="cart.length" class="col-md-4 right">
                    <div class="cart-summary">
                        <div class="cart-detailed-totals">
                            <div class="card-block">
                                <div class="cart-summary-line" id="cart-subtotal-products">
                                    ...
                                    <span class="value">{{ (totalPrice * calculCurrency).toFixed(2) }} &nbsp;{{ currency }}</span>
                                </div>
                        ...
                        <div class="checkout cart-detailed-actions card-block">
                            ...
                            <a href="http://demo.posthemes.com/pos_nego/layout3/fr/commande" class="btn btn-primary">Commander</a>  
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <router-link class="label-continuer-achat" :to="{ name: 'categories' }">
                    <i class="fa fa-chevron-left" aria-hidden="true"></i>Continuer mes achats
                </router-link>
...
.cart .left .cart-left .cart-body .product-line-grid-body .product-line-info .label {
