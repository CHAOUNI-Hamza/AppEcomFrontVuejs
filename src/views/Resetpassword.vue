            ...
            <div class="col-md-5">
                <div class="left">
                    <form @submit.prevent="resetpassword()">
                        ...
                        <div class="mb-3">
                            <input v-model="user.password_confirmation" type="password" class="form-control" id="exampleInputPassword2" placeholder="password confirmation">
                        </div>
                        <div class="checkbox"><label for=""><input type="checkbox" value="option1"><span class="checkbox-input"></span> Subscribe to stay updated with new products and offers! </label></div>
