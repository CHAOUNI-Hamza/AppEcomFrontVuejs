<template>
  ...
  <div class="container accordion-generale">
    <div class="row">
    ...
    <div class="accordion" id="accordionExample">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="headingThreeu">
          <button
            class="accordion-button collapsed"
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#headingfor345"
            aria-expanded="false"
            aria-controls="collapseThree">
...
.accordion-generale .accordion-item {
  border-radius: 0;
  margin-bottom: 14px;
  border: 1px solid #00000000 !important;
}
.accordion-generale .accordion-item .accordion-button {
  background: #00bcd429;
}
</style>
