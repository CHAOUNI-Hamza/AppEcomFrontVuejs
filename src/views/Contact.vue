            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="info-block">
                        <div class="text">
                            <p>
                                <b>ADDRESS: </b>55 Gallaxy Enque, 2568 steet,<br> 23568 NY
                            </p>
                            <p>
                            ...
                            <p>Mon - Sat : 9am - 11pm <br> Sunday:11am - 5pm</p>
...
<script>
import FormContact from '../components/FrontEnd/FormContact.vue'
export default {
  components: {
    FormContact
  },
...
.contact form .text-fields-error {
    border: 1px solid #ff00008f !important;
}
.contact form .text-fields-error::placeholder {
