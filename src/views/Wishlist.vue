            ...
            <div class="row justify-content-center">
                <div class="col-md-8 left">
                    <div class="cart-left">
                        ...
                        <hr>
                        <div v-if="wish.length" class="cart-body">
                            <ul>
                                <li v-for="item in wish" :key="item.id">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="img-wrap">
                                        ...
                                        <div class="col-md-6">
                                            <span>
                                                <router-link :to="{ name:'home' }" class="btn v-product">View Product</router-link>
                                            </span>
                                            <span>
                                                <button @click="removeItemFromWish(item.id)" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div v-else class="cart-body">
                            <p>
                                he products were not added to the wishlist.
                            </p>
                        </div>
                    </div>
                </div>
...
export default {
  ...
  methods: {
    ...mapActions(["reduceQtyWish","addQtyWish","removeItemFromWish"]),
  },
  mounted() {
