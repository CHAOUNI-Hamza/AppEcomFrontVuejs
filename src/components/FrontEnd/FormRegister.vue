  ...
  <form @submit.prevent="registerUser()">
    <div class="mb-3">
      <input
        ...
        :class="{ 'text-fields-error': v$.user.firstname.$error === true }"
    ...
    <div class="mb-3">
      <input
        ...
        :class="{ 'text-fields-error': v$.user.lastname.$error === true }"
    ...
    <button type="submit" :class="{ disabled: !valideToCheckout }" class="btn">
      Submite
    </button>
  </form>
  <!-- end Form Register -->
