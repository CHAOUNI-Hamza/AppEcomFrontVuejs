      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" ref="carousel">
        <div class="carousel-inner">
          <div class="carousel-item carousel-one"
            ...
            :key="carousel.id"
            v-bind:style="{ backgroundImage: 'url(' + carousel.image + ')', height: heightCarousel + 'px' }"
...
export default {
  ...
  methods: {
    getHeightCarousel() {
      this.heightCarousel =  window.innerHeight - (this.heightBarMessage + this.heightNavbar)
    },
    ...mapActions({
...
@media (max-width: 983px) {
  .slider .caption-one, .slider .caption-two {
  top: 50%;
  left: 50%;
  width: 70%;
}
