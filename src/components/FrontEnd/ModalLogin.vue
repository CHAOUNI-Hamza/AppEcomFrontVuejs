            ...
            <div class="row">
              ...
              <div class="col-6 right">
                <img
                  ...
                  width="100%"
                  height="100%"
                  src="https://img.freepik.com/free-photo/smiling-attractive-woman-stylish-colorful-outfit-jumping-with-shopping-bags-pink-yellow-background-polo-neck-striped-mini-skirt-shopaholic-sale-fashion-summer-trend_285396-2421.jpg?w=2000"
                  alt="" />
                <a
                  type="button"
                  data-bs-toggle="modal"
