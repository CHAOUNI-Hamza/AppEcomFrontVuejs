  ...
  <form @submit.prevent="submit()">
    <div class="row mb-3">
      <div class="col-md-6">
        ...
        <div
          class="input-errors"
          v-for="error of v$.messages.name.$errors"
          :key="error.$uid">
      ...
      <div class="col-md-6">
        ...
        <div
          class="input-errors"
          v-for="error of v$.messages.email.$errors"
          :key="error.$uid">
          <div class="error-msg">{{ error.$message }}</div>
        </div>
      </div>
    ...
    <div class="mb-3">
      ...
      <div
        class="input-errors"
        v-for="error of v$.messages.phone.$errors"
        :key="error.$uid">
        <div class="error-msg">{{ error.$message }}</div>
      </div>
    </div>
    <div class="mb-3">
      ...
      <div
        class="input-errors"
        v-for="error of v$.messages.subject.$errors"
        :key="error.$uid">
        <div class="error-msg">{{ error.$message }}</div>
      </div>
    </div>
